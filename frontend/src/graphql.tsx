...
export type GetMessagesByRoomSubscription = { __typename?: 'subscription_root', message: Array<{ __typename?: 'message', uuid: any, content: string, created_at: any, reply_to_uuid?: any | null, user: { __typename?: 'user', uuid: any, username: string }, reply_to?: { __typename?: 'message', uuid: any, content: string, user: { __typename?: 'user', username: string } } | null }> };

export type AddReplyMessageMutationVariables = Exact<{
  user_uuid: Scalars['uuid']['input'];
  room_uuid: Scalars['uuid']['input'];
  content: Scalars['String']['input'];
  reply_to_uuid: Scalars['uuid']['input'];
}>;


export type AddReplyMessageMutation = { __typename?: 'mutation_root', insert_message_one?: { __typename?: 'message', uuid: any, content: string, created_at: any, reply_to_uuid?: any | null, user: { __typename?: 'user', username: string }, reply_to?: { __typename?: 'message', content: string, user: { __typename?: 'user', username: string } } | null } | null };
...
export const AddReplyMessageDocument = gql`
    mutation addReplyMessage($user_uuid: uuid!, $room_uuid: uuid!, $content: String!, $reply_to_uuid: uuid!) {
  insert_message_one(
    ...
    `;
export type AddReplyMessageMutationFn = Apollo.MutationFunction<AddReplyMessageMutation, AddReplyMessageMutationVariables>;

/**
 * __useAddReplyMessageMutation__
 *
 * To run a mutation, you first call `useAddReplyMessageMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddReplyMessageMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [addReplyMessageMutation, { data, loading, error }] = useAddReplyMessageMutation({
 *   variables: {
 *      user_uuid: // value for 'user_uuid'
 *      room_uuid: // value for 'room_uuid'
 *      content: // value for 'content'
 *      reply_to_uuid: // value for 'reply_to_uuid'
 *   },
 * });
 */
export function useAddReplyMessageMutation(baseOptions?: Apollo.MutationHookOptions<AddReplyMessageMutation, AddReplyMessageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddReplyMessageMutation, AddReplyMessageMutationVariables>(AddReplyMessageDocument, options);
      }
export type AddReplyMessageMutationHookResult = ReturnType<typeof useAddReplyMessageMutation>;
export type AddReplyMessageMutationResult = Apollo.MutationResult<AddReplyMessageMutation>;
export type AddReplyMessageMutationOptions = Apollo.BaseMutationOptions<AddReplyMessageMutation, AddReplyMessageMutationVariables>;
