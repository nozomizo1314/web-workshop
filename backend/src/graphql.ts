...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    addReplyMessage(variables: AddReplyMessageMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AddReplyMessageMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddReplyMessageMutation>(AddReplyMessageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'addReplyMessage', 'mutation', variables);
    },
